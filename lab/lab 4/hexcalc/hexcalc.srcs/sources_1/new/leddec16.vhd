...
BEGIN
	...
	anode <= "1110" WHEN dig = "00" AND conv_integer(data) >= 0 ELSE -- digit 0
	         "1101" WHEN dig = "01" AND conv_integer(data) >= 16 ELSE -- digit 1
	         "1011" WHEN dig = "10" AND conv_integer(data) >= 256 ELSE -- digit 2
	         "0111" WHEN dig = "11" AND conv_integer(data) >= 4096 ELSE -- digit 3
	         "1111";
END Behavioral;