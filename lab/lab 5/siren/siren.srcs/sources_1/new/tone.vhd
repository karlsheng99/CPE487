...
BEGIN
	...
	WITH quad SELECT
    data_sq <= TO_SIGNED(16383, 16) WHEN "00", -- 1st quadrant
            TO_SIGNED(-16383, 16) WHEN "01", -- 2nd quadrant
            TO_SIGNED(16383, 16) WHEN "10", -- 3rd quadrant
            TO_SIGNED(-16383, 16) WHEN OTHERS; -- 4th quadrant
